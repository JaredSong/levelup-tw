...
const BANKS = [
  ...
  },
  {
    ...
    optionRectOverrides: {
      '01300-01-017': [null, null, null, { x: 110, y: 526, width: 110, height: 50 }],
      '01300-01-024': [null, null, { x: 118, y: 208, width: 82, height: 36 }, null],
      '01300-01-029': [
        { x: 440, y: 576, width: 49, height: 24 },
        { x: 118, y: 604, width: 54, height: 22 },
        { x: 197, y: 604, width: 54, height: 22 },
        { x: 274, y: 604, width: 52, height: 22 },
      ],
      '01300-03-001': [null, null, null, { x: 119, y: 71, width: 37, height: 31 }],
      '01300-03-018': [null, null, null, { x: 118, y: 369, width: 115, height: 55 }],
      '01300-04-105': [
        { x: 120, y: 316, width: 70, height: 55 },
        { x: 390, y: 268, width: 74, height: 48 },
        { x: 233, y: 327, width: 74, height: 45 },
        { x: 346, y: 337, width: 72, height: 40 },
      ],
      '01300-05-091': [
