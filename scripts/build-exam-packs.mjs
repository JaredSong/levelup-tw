...
const EXAMS = [
  ...
  },
  {
    ...
    extraCommonCodes: ['90010'],
    excludedFigureIds: ['20600-03-058'],
    requireQuestionCrops: true,
    splitImageOptions: true,
    mockRules: {
      occupationQuota: 60,
  ...
  },
  {
    ...
    level: '丙級',
    category: '金屬及機械加工',
    occupationCode: '02100',
    occupationFile: '021003A12-raw.txt',
    occupationExpected: 609,
    version: 'A12',
  ...
  },
  {
    ...
    occupationSourceKey: '12000-2',
    occupationFile: '120002A12-raw.txt',
    occupationExpected: 773,
    version: 'A12',
    ...
    requireQuestionCrops: true,
    splitImageOptions: true,
    mixedFigureOptionIds: ['12000-01-022', '12000-01-023'],
    excludedFigureIds: ['12000-01-025'],
    inactiveIds: ['12000-01-025', '12000-04-014', '12000-06-010'],
    mockRules: {
      occupationQuota: 60,
      singleCount: 80,
      multipleCount: 0,
  ...
  },
  {
    ...
    occupationFile: '172003A14-raw.txt',
    occupationExpected: 486,
    version: 'A14',
